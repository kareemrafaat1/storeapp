...
class BevargesPage extends StatefulWidget {
  const BevargesPage({super.key});

  @override
  State<BevargesPage> createState() => _BevargesPageState();
}

class _BevargesPageState extends State<BevargesPage> {
  @override
